...
if __name__ == "__main__":
    ...
    # pdf_mcnp = get_pdf_mcnp(
    #     f"/Users/atumulak/Developer/mcnp6-runs/broomstick/endf80-{E}eV-{T:.1f}K.mctal",
    #     E,
    #     T,
    #     label="MCNP (tabular)",
    # )
    # pdf_minimc = get_pdf_minimc(
    #     f"/Users/atumulak/Developer/minimc/benchmarks/broomstick.out",
    #     E,
    #     T,
    #     label="MiniMC (POD)",
    # )

    # pdf_problem = get_pdf_minimc(
    #     f"/Users/atumulak/Developer/minimc/benchmarks/broomstick.problem.out",
    #     E,
    #     T,
    #     label="MiniMC (POD)",
    # )
    # pdf_noproblem = get_pdf_minimc(
    #     f"/Users/atumulak/Developer/minimc/benchmarks/broomstick.noproblem.out",
    #     E,
    #     T,
    #     label="MiniMC (POD)",
    # )
    # marginalize(pdf_problem, axis="beta").plot()
    # marginalize(pdf_noproblem, axis="beta").plot()
    # plt.show()
    ...
    # plt.grid(True)
    # tpl.clean_figure()
    # tpl.save("beta_partitioned_comparison.tex")
    ...
    # plt.grid(True)
    # # tpl.clean_figure()
    # # tpl.save('alpha_partitioned_comparison.tex')
    # plt.show()
    ...
    # pod_segments_y = np.array([0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 1.000000e-07, 1.000000e-07, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 1.000000e-07, 0.000000e+00, 0.000000e+00, 0.000000e+00, 2.000000e-07, 0.000000e+00, 0.000000e+00, 0.000000e+00, 1.000000e-07, 0.000000e+00, 0.000000e+00, 0.000000e+00, 1.000000e-07, 0.000000e+00, 1.000000e-07, 2.000000e-07, 1.000000e-07, 0.000000e+00, 0.000000e+00, 3.000000e-07, 0.000000e+00, 2.000000e-07, 1.000000e-07, 2.000000e-07, 1.000000e-07, 1.000000e-07, 3.000000e-07, 0.000000e+00, 4.000000e-07, 3.000000e-07, 2.000000e-07, 3.000000e-07, 6.000000e-07, 5.000000e-07, 4.000000e-07, 3.000000e-07, 7.000000e-07, 1.000000e-06, 1.000000e-06, 8.000000e-07, 7.000000e-07, 9.000000e-07, 1.000000e-06, 1.500000e-06, 2.000000e-06, 1.800000e-06, 2.700000e-06, 2.700000e-06, 2.100000e-06, 3.400000e-06, 2.300000e-06, 3.200000e-06, 3.300000e-06, 3.400000e-06, 3.800000e-06, 5.300000e-06, 6.400000e-06, 6.600000e-06, 7.000000e-06, 9.300000e-06, 8.800000e-06, 9.800000e-06, 1.080000e-05, 1.380000e-05, 1.450000e-05, 1.600000e-05, 1.610000e-05, 1.750000e-05, 2.210000e-05, 2.260000e-05, 2.750000e-05, 3.350000e-05, 3.360000e-05, 4.030000e-05, 4.750000e-05, 5.130000e-05, 6.030000e-05, 7.340000e-05, 7.920000e-05, 9.370000e-05, 1.056000e-04, 1.185000e-04, 1.367000e-04, 1.644000e-04, 1.843000e-04, 2.022000e-04, 2.328000e-04, 2.651000e-04, 3.100000e-04, 3.338000e-04, 3.948000e-04, 4.354000e-04, 5.014000e-04, 5.677000e-04, 6.298000e-04, 7.183000e-04, 8.146000e-04, 9.221000e-04, 1.044500e-03, 1.155500
2.840000e-05, 3.240000e-05, 3.910000e-05, 4.260000e-05, 4.930000e-05, 5.610000e-05, 6.160000e-05, 7.230000e-05, 7.840000e-05, 9.760000e-05, 1.044000e-04, 1.252000e-04, 1.444000e-04, 1.632000e-04, 1.968000e-04, 2.143000e-04, 2.450000e-04, 2.706000e-04, 3.134000e-04, 3.476000e-04, 3.940000e-04, 4.582000e-04, 5.137000e-04, 5.771000e-04, 6.523000e-04, 7.268000e-04, 8.450000e-04, 9.504000e-04, 1.066800e-03, 1.196000e-03, 1.336300e-03, 1.496700e-03, 1.659000e-03, 1.854800e-03, 2.056900e-03, 2.262200e-03, 2.524400e-03, 2.753100e-03, 3.035000e-03, 3.316900e-03, 3.659600e-03, 3.960500e-03, 4.322000e-03, 4.645200e-03, 5.032600e-03, 5.413100e-03, 5.739000e-03, 6.095300e-03, 6.450800e-03, 6.801100e-03, 7.140400e-03, 7.468700e-03, 7.738700e-03, 7.936900e-03, 8.120800e-03, 8.228400e-03, 8.336400e-03, 8.319100e-03, 8.243800e-03, 8.155400e-03, 7.978300e-03, 7.724100e-03, 7.474000e-03, 7.034900e-03, 6.559800e-03, 6.106900e-03, 5.611300e-03, 5.089200e-03, 4.576900e-03, 4.063400e-03, 3.595700e-03, 3.138000e-03, 2.732900e-03, 2.324600e-03, 2.001600e-03, 1.748800e-03, 1.510900e-03, 1.322200e-03, 1.182700e-03, 1.096400e-03, 1.075200e-03, 1.075300e-03, 1.119700e-03, 1.079000e-03, 2.941500e-03, 7.406000e-04, 3.424000e-04, 1.878000e-04, 1.017000e-04, 7.460000e-05, 6.050000e-05, 5.190000e-05, 4.800000e-05, 4.290000e-05, 3.650000e-05, 1.980000e-05, 9.100000e-06, 4.100000e-06, 2.700000e-06, 1.200000e-06, 1.100000e-06, 3.000000e-07, 1.000000e-07, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00])
    ...
    # plt.grid(True)
    # tpl.clean_figure()
    # tpl.save('partitioned_spectrum_comparison.tex')

    # prefix = "/Users/atumulak/Developer/minimc/data/tsl/endfb8-adaptive-coarse/dfs/"
    # for filename in os.listdir(prefix):
    #     df = pd.read_hdf(prefix+filename)
    #     order = np.linalg.matrix_rank(df)
    #     U_df, S_df, V_df = to_svd_dfs(df, order)
    #     df_reconstructed = reconstruct_from_svd_dfs(U_df, S_df, V_df)
    #     print(f"Error: {np.linalg.norm(df - df_reconstructed)}")
    #     name, chunk = os.path.splitext(filename)[0].split("_")
    #     file_prefix = "_".join([name, "endfb8", chunk])
    #     U_df.to_hdf(file_prefix + "_CDF_coeffs.hdf5", "pandas")
    #     S_df.to_hdf(file_prefix + "_S_coeffs.hdf5", "pandas")
    #     V_postfix = "_" + V_df.index.names[0] + "_" + V_df.index.names[1] + "_coeffs.hdf5"
    #     V_df.to_hdf(file_prefix + V_postfix, "pandas")
